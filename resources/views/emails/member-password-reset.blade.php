                ...
                <table width="520" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:36px 40px 0;">
                            ...
                            <p style="margin:0 0 16px;font-size:22px;font-weight:800;color:#1e293b;">Reset your password</p>
                            <p style="margin:0;font-size:15px;color:#475569;line-height:1.6;">
                                Hello, <strong style="color:#1e293b;">{{ $member->first_name }}</strong>. We received a request to reset the password for your account.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:28px 40px 0;text-align:center;">
                            <a href="{{ $resetUrl }}" style="display:inline-block;background-color:#e85d26;color:#ffffff;font-size:15px;font-weight:700;text-decoration:none;padding:14px 32px;border-radius:100px;">
                                Reset Password
                            </a>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="background-color:#fff7ed;border:1px solid #fed7aa;border-radius:10px;padding:14px 18px;">
                                        <p style="margin:0;font-size:13px;color:#92400e;line-height:1.5;">
                                            ⏱ This link will expire in <strong>1 hour</strong>. If you didn't request a password reset, you can safely ignore this email — your account is secure.
                                        </p>
                                    </td>
                                </tr>
                            </table>
