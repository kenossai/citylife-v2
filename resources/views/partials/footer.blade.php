        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <span class="text-white font-semibold text-sm">City Life <span class="text-gray-400 font-light">International</span></span>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li class="flex items-start gap-2">
                        ...
                        <span>123 City Life Ave,<br>Sheffield, S1 2AB</span>
                    </li>
