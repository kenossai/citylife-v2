                ...
                <div class="flex flex-col items-center gap-10 {{ $index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse' }}">
                    ...
                    <div class="w-full shrink-0 lg:w-[380px]">
                        ...
                        <div class="mt-4 flex items-center justify-center gap-3">
                            @if (!empty($pastor->social_instagram))
                                <a href="{{ $pastor->social_instagram }}" class="flex h-9 w-9 items-center justify-center rounded-full border border-[#e5e7eb] text-[#667085] transition-colors hover:border-[#e85d26] hover:text-[#e85d26]" aria-label="Instagram">
                            ...
                            @endif
                            @if (!empty($pastor->social_twitter))
                                <a href="{{ $pastor->social_twitter }}" class="flex h-9 w-9 items-center justify-center rounded-full border border-[#e5e7eb] text-[#667085] transition-colors hover:border-[#e85d26] hover:text-[#e85d26]" aria-label="X / Twitter">
                                    <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                                </a>
                            @endif
                            @if (!empty($pastor->social_youtube))
                                <a href="{{ $pastor->social_youtube }}" class="flex h-9 w-9 items-center justify-center rounded-full border border-[#e5e7eb] text-[#667085] transition-colors hover:border-[#e85d26] hover:text-[#e85d26]" aria-label="YouTube">
                            ...
                            @endif
                            @if (!empty($pastor->social_facebook))
                                <a href="{{ $pastor->social_facebook }}" class="flex h-9 w-9 items-center justify-center rounded-full border border-[#e5e7eb] text-[#667085] transition-colors hover:border-[#e85d26] hover:text-[#e85d26]" aria-label="Facebook">
