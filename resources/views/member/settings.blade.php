...
<div class="mb-6 rounded-2xl bg-white border border-gray-200 shadow-sm overflow-hidden">
    <div class="px-6 pt-5 pb-4 border-b border-gray-100">
        ...
        <p class="text-xs text-gray-400 mt-0.5 ml-6">Update your personal details</p>
    </div>
        ...
        <div class="flex items-center gap-4 mb-6"
            ...
            <div class="relative shrink-0 group">
                <template x-if="preview">
                    <img :src="preview" alt="Avatar"
                         class="h-16 w-16 rounded-2xl object-cover ring-2 ring-[#e85d26]/30">
                </template>
                <template x-if="!preview">
                    <div class="h-16 w-16 rounded-2xl bg-[#e85d26] flex items-center justify-center text-white font-extrabold text-xl uppercase select-none">
            ...
            <div>
                ...
                <form method="POST" action="{{ route('member.settings.avatar') }}"
                      enctype="multipart/form-data" id="avatar-form" class="mt-1.5">
                    @csrf
                    <label class="cursor-pointer text-xs font-semibold text-[#e85d26] hover:text-[#cf4f1e] transition-colors">
                        Change Avatar
        ...
        <form method="POST" action="{{ route('member.settings.profile') }}">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="sm:col-span-2 sm:max-w-xs">
                    <label class="block text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1.5">Location</label>
                    <div class="relative">
                        <span class="pointer-events-none absolute inset-y-0 left-3 flex items-center">
                            <svg class="h-3.5 w-3.5 text-gray-300" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            {{-- Bio --}}
            <div class="mt-4">
                <label class="block text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-1.5">Bio</label>
                <textarea name="bio" rows="3" maxlength="500"
                          placeholder="A short bio about yourself…"
                          class="w-full rounded-lg border border-gray-200 bg-gray-50 px-4 py-2.5 text-sm text-gray-800 placeholder-gray-300 focus:border-[#e85d26] focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#e85d26]/20 transition resize-none">{{ old('bio', $member->bio) }}</textarea>
            </div>
