...
<head>
    ...
    <title>Reset Password — City Life International</title>
    ...
    <div class="flex flex-1 items-center justify-center px-4 py-16">
        <div class="w-full max-w-sm">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-3xl font-extrabold text-[#101828] leading-tight">Set a new password</h1>
                <p class="text-gray-500 text-sm mt-2">Choose a strong password for your account.</p>
            </div>

            {{-- Card --}}
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">

                <form method="POST" action="{{ route('member.password.update', $token) }}" class="space-y-5" x-data="{ show: false }">
                    @csrf
